...
@testset "Gravitational Functional Test" begin
    ...
    @testset "The well-known figure Eight choreography" begin
        ...
        m3 = MassBody(SVector(0.0, 0.0, 0.0), SVector(0.695804, 1.06786, 0.0), 1.0)
        t1 = 0.0
        t2 = 2pi
        tspan = (t1, t2)
    ...
    @testset "5-body choreography" begin
        ...
        m2 = MassBody(
            SVector(0.439775, -0.169717, 0.0), SVector(1.822785, 0.128248, 0.0),
            1.0
        )
        m3 = MassBody(
            SVector(-1.268608, -0.267651, 0.0), SVector(1.271564, 0.168645, 0.0),
            1.0
        )
        m4 = MassBody(
            SVector(-1.268608, 0.267651, 0.0), SVector(-1.271564, 0.168645, 0.0),
